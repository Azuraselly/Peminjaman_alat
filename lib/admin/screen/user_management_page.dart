...
class _UserManagementPageState extends State<UserManagementPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Menggunakan Stack agar notifikasi bisa muncul melayang di atas body
      body: Stack(
        children: [
          // Konten Utama
          Column(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    _buildSquareBtn(Icons.tune, () {}, color: Colors.white),
                  ],
                ),
              ),
              Expanded(
                child: ListView(
                  ...
                  children: [
                    UserCard(
                      ...
                      status: "Aktif",
                      isActive: true,
                      onDelete: () => _showDeleteConfirmation("Azura"),
                      onTapProfile: () {
                    ...
                    UserCard(
                      ...
                      status: "Tidak Aktif",
                      isActive: false,
                      onDelete: () => _showDeleteConfirmation("AULIA"),
                      onTapProfile: () {
                        // Navigasi ke Halaman Detail User
                        Navigator.push(
                          context,
